...
description: "All it took was this simple weekly approach and patience."
date: "2018-06-09"
---

![How my startup grew by over 1M users in one month](/images/blog/how-my-startup-grew-by-over-1m-users-in-one-month/img-1.png)
...
![How my startup grew by over 1M users in one month](/images/blog/how-my-startup-grew-by-over-1m-users-in-one-month/img-2.gif)
...
Your goal should always be one: **improving customer retention**. For those who are not familiar with what customer retention is, [click here](https://en.wikipedia.org/wiki/Customer_retention).
...
A core component of Lean Startup methodology is the [build-measure-learn feedback loop](https://www.mindtools.com/pages/article/build-measure-learn.htm).
...
Whenever my team and I are working on a product, here are the steps we take:
...
![User activity from March 2017 to January 2018](/images/blog/how-my-startup-grew-by-over-1m-users-in-one-month/img-3.png)
...
With these results, we prioritized and went on to our next assumption, which was to add buttons to the flow of setting a reminder (conclusion three). And guess what? That assumption also turned out to be true. For more proven assumptions, you can read my article on [How to improve your chatbot](https://chatbotsmagazine.com/how-to-improve-your-chatbot-in-3-simple-steps-36f9d26d7f2f).
...
![Daily new users from Feb 17 to March 17](/images/blog/how-my-startup-grew-by-over-1m-users-in-one-month/img-4.png)
...
![Total user growth from Jan 18' to May 18'](/images/blog/how-my-startup-grew-by-over-1m-users-in-one-month/img-5.png)
