...
description: "GPT Researcher: the future of comprehensive online research"
date: "2023-07-24"
---

![How I Built an Autonomous AI Agent for Online Research](/images/blog/how-i-built-an-autonomous-ai-agent-for-online-research/img-1.png)

After [AutoGPT](https://en.wikipedia.org/wiki/Auto-GPT) was published, I immediately took it for a spin. The first use case that came to mind was autonomous online research. Forming objective conclusions for manual research tasks can take time, sometimes weeks, to find the right resources and information. Seeing how well AutoGPT created tasks and executed them got me thinking about the great potential of using AI to conduct comprehensive research and what it meant for the future of online research.
...
![Example inputs and outputs of GPT-3 with (a) Zero-shot-CoT prompting, (b) Plan-and-Solve (PS) prompting](/images/blog/how-i-built-an-autonomous-ai-agent-for-online-research/img-2.png)
...
By levering Python libraries such as `[asyncio](https://docs.python.org/3/library/asyncio.html)`, the agent tasks have been optimized to work in parallel, thus significantly reducing the time to research.

```
# Create a list to hold the coroutine agent taskstasks = [async_browse(url, query, self.websocket) for url in await new_search_urls]# Gather the results as they become availableresponses = await asyncio.gather(*tasks, return_exceptions=True)
```
...
Now that we’ve reviewed the necessary steps of [GPT Researcher](https://github.com/assafelovic/gpt-researcher), let’s break down the final architecture, as shown below:

![GPT Researcher’s high-level architecture](/images/blog/how-i-built-an-autonomous-ai-agent-for-online-research/img-3.png)
*GPT Researcher’s high-level architecture*
