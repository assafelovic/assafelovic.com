...
description: "The idea is only a fraction of what it takes for a startup to succeed"
date: "2019-10-06"
---

![How to Evaluate Startup Ideas — Part 1](/images/blog/how-to-evaluate-startup-ideas/img-1.png)

After graduating from Y Combinator Startup School and building several startups, with the recent [reaching over 5M users](/free-code-camp/how-my-app-grew-by-5-800-in-one-month-with-no-branding-or-marketing-d0bafb93108), I’ve been eager to share lessons learned when evaluating startup ideas.

According to a [TED talk](https://www.ted.com/talks/bill_gross_the_single_biggest_reason_why_startups_succeed?language=en) by Bill Gross, founder of Idealab, **timing** accounts for 42% of a startup’s success. He looked at [five factors](https://www.forbes.com/sites/bernhardschroeder/2019/09/23/what-is-the-most-important-element-of-a-successful-startup-hint-its-not-the-idea-team-business-model-or-funding-dollars/#61cd9c5c727c) (funding, business model, team, idea, timing) that he believed are important, to get the one factor that accounts for a startup’s success. After analyzing the five factors on hundreds of successful startups, funding and idea only accounted for 14%-28% while timing hit the jackpot.

![How to Evaluate Startup Ideas — Part 1](/images/blog/how-to-evaluate-startup-ideas/img-2.jpg)
...
One of my favorite metrics for evaluating the readiness of a market is called the [Knowledge Spectrum](https://www.yourdictionary.com/spectrum-of-knowledge) as seen below.

![How to Evaluate Startup Ideas — Part 1](/images/blog/how-to-evaluate-startup-ideas/img-3.png)
...
There are [many examples](https://www.quora.com/What-are-some-examples-of-companies-that-succeeded-as-a-result-of-perfect-timing) of successful startups that had good timing on their side (Facebook), or that were too late in the game (Windows Mobile). So let’s give some interesting examples of startups that were too early, to emphasize the importance of market education. [**WebVan**](https://en.wikipedia.org/wiki/Webvan) provided online grocery shopping in the late 1990s. Around the-dot com bubble, consumers were still not educated in using the internet for on-demand services (knowledge gap was too wide). WebVan burned through almost $400M in venture funding, only to crash and burn, yet ordering groceries online is commonplace today.

Another good example is [**Dodgeball**](https://en.wikipedia.org/wiki/Dodgeball_\(service\)) which offered social location sharing via text messages as early as 2003. The company was acquired but eventually shut down. Checking into locations is now common behavior on Facebook and similar platforms.
