...
export default function Projects() {
  return (
    <>
      <p className="mb-5 font-mono text-[15px] text-muted">$ ls projects/</p>
          ...
          <li key={project.name} className="border-b border-line">
            ...
            >
              <span className="flex items-baseline gap-4">
                <span className="text-[18px] font-medium decoration-muted/60 underline-offset-3 group-hover:underline">
                  {project.name}
                </span>
              ...
              <span className="mt-1 block text-[16px] leading-relaxed text-muted">
                {project.description}
              </span>
            </a>
          </li>
